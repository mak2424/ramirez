...
set output 'HGS_dos64_J0_1.dat_g.png'
...
set terminal png font "Times New Roman,24" size 1000, 1000
set output 'HGS_dos64_J0_1.dat_Egs.png'
set title "HGS_dos64_J0_1.dat" textcolor lt 3
set ylabel "Egs" font "Times New Roman,28"
set xlabel "H" font "Times New Roman,28"
plot 'HGS_dos64_J0_1.dat' using 1:4 with lines lw 2 notitle, 'HGS_dos64_J0_1.dat' using 1:4 pt 7 lc 7 ps 2 notitle
