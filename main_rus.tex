...
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{figs/C(g)}
	\caption{Теплоемкость для разных $G$ при $T=0.4$}
	\label{fig:C(g)}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{figs/C(f)}
	\caption{Теплоемкость для разных $f$ при $T=0.4$}
	\label{fig:C(f)}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{figs/Xi(g)}
	\caption{Восприимчивость для разных $G$ при $T=0.4$}
	\label{fig:Xi(g)}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{figs/Xi(f)}
	\caption{Восприимчивость для разных $f$ при $T=0.4$}
	\label{fig:Xi(f)}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth]{figs/Xi(M)}
	\caption{Восприимчивость для разных $Mmax$ при $T=0.4$}
	\label{fig:Xi(Mmax)}
\end{figure}
